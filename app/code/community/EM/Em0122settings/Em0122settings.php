<?php
/**
 * @deprecated use Mage::helper('em0122settings') instead
 * @methods:
 * - get[Section]_[ConfigName]($defaultValue = '')
 */
class EM_Em0122settings_Em0122settings
{	
	/**
     * @return array
     * Get css config
    */    
    public function getAllCssConfig() {
        ...
        $configs = array();
        $skinUrl = 'frontend/default/em0122/css/';
        ...
        */
        ...
        $xml = $themeHelper->loadTheme('em0122');
        ...
        $page_bg_image = $themeHelper->getConfigTheme('typo_general_page_bg_file') ? 
			'media/em0122/variations/'.$themeHelper->getConfigTheme('typo_general_page_bg_file')
        ...
        $header_bg_image = $themeHelper->getConfigTheme('header_header_bg_file') ? 
			'media/em0122/variations/'.$themeHelper->getConfigTheme('header_header_bg_file')
        ...
        $body_bg_image = $themeHelper->getConfigTheme('body_body_bg_file') ? 
			'media/em0122/variations/'.$themeHelper->getConfigTheme('body_body_bg_file')
        ...
        $footer_bg_image = $themeHelper->getConfigTheme('footer_footer_bg_file') ? 
			'media/em0122/variations/'.$themeHelper->getConfigTheme('footer_footer_bg_file')
