<?php 
class EM_Em0122settings_Model_Config_Font
{
	const CACHE_KEY = 'EM0122_GOOGLE_FONTS';
    ...
    public function toOptionArray()
    {
        ...
        $googlefonts_url = 'https://www.googleapis.com/webfonts/v1/webfonts?sort=popularity&key='.Mage::helper('themeframework/settings')->getFonts_GoogleFontsKey('AIzaSyCZ6wqklkyJFXWvoxvA5Zv0SGzHTd6JbbI');       
