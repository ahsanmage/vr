...
class EM_Em0122settings_Model_Observer
{
    public function beforeGenerateBlocks(Varien_Event_Observer $observer)
    {
        if ((Mage::getSingleton('core/design_package')->getPackageName() == 'em0122') &&
    ...
    {
        $observer->getHead()->addCSS('em0122/em0122.css');
        $observer->getHead()->addItem('skin_js', 'em0122/em0122.js');
        return $this;
    }
}
