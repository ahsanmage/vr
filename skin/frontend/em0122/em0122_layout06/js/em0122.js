...
(function($) {
    ...
    function doSliderOwl() {
        ...
        if ($len) {
            for (var i = 0; i < $len; i++) {
				...
				var autoPlay=getOption(owl, 'emslider-autoplay', false);
	...
	function prepareSlideshow() {
		if((header_style!="style06")&&($(".em-area-01").hasClass("col-sm-19"))){
			$(".em-area-01").removeClass("col-sm-19 col-sm-push-5 ");
			$(".em-area-01").addClass("col-sm-24");
		}
	}
